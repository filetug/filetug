...
tools: ['read/readFile', 'agent', 'memory', 'vscode/memory']
---
<!-- Drafted from: https://gist.github.com/burkeholland/0e68481f96e94bbb98134fa6efd00436#file-three-agent-md -->
...
- **Go-coder** — Writes & Analyzes Go code, fixes bugs, implements logic
- **TS-coder** — Writes & Analyzes TypeScript code, fixes bugs, implements logic
- **Coder** — Writes code (_except Go and TypeScript_), fixes bugs, implements logic
